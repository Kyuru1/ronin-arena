  ...
  return <div className="px-backdrop absolute inset-0 z-40 flex items-center justify-center p-3 sm:p-6">
    <PxFrame title="COMO VOCE VAI JOGAR?" className="anim-pop w-full max-w-2xl p-4 sm:p-6">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        ...
        <PxButton tone="menu" onClick={() => onSelect("gamepad")} className="min-h-28 flex-col gap-3 p-3 text-center"><strong className="text-[9px]">CONTROLE</strong><span className="text-[6px] leading-4 text-[#a9c3be]">Analógicos e botões do controle.</span></PxButton>
      </div>
